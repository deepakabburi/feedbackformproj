...
$Update = "UPDATE gitam1 SET Student='$_POST[student]' Attendance='$_POST[attendance]' WHERE Student='$_POST[hidden]'";    
...
while($record=mysql_fetch_array($data))
{
    ...
    echo "<tr>";
    echo "<td>" . "<input type=text name=attendance value=" . $record['Student'] . " </td>";
